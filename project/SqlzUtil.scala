...
object SqlzUtil {
  ...
  lazy val commonSettings = Seq(
    ...
    scalacOptions in (Compile, doc) ++= Seq(
      ...
      "-doc-source-url", "https://github.com/jacoby6000/sqlz/tree/v" + version.value + "${FILE_PATH}.scala"
    ),
  ...
  def publishSettings(packageName: String) = osgiSettings ++ Seq(
    ...
    homepage := Some(url("https://github.com/jacoby6000/sqlz")),
    apiURL := Some(url("https://github.com/jacoby6000/sqlz/tree/master")),
    pomIncludeRepository := Function.const(false),
    pomExtra :=
    <scm>
      <url>git@github.com:Jacoby6000/sqlz.git</url>
      <connection>scm:git:git@github.com:Jacoby6000/sqlz.git</connection>
    </scm>
    <developers>
      <developer>
        <id>Jacoby6000</id>
  ...
  lazy val sqlzSettings = buildSettings ++ commonSettings
}
